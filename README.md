# gRPCurl
[![Build Status](https://circleci.com/gh/dtomcej-netskope/grpcurl/tree/master.svg?style=svg)](https://circleci.com/gh/dtomcej-netskope/grpcurl/tree/master)
[![Go Report Card](https://goreportcard.com/badge/github.com/dtomcej-netskope/grpcurl)](https://goreportcard.com/report/github.com/dtomcej-netskope/grpcurl)
...
This repo also provides a library package, `github.com/dtomcej-netskope/grpcurl`, that has
...
Download the binary from the [releases](https://github.com/dtomcej-netskope/grpcurl/releases) page.
...
```shell
# Download image
docker pull dtomcej-netskope/grpcurl:latest
# Run the tool
docker run dtomcej-netskope/grpcurl api.grpc.me:443 list
```
...
```shell
go install github.com/dtomcej-netskope/grpcurl/cmd/grpcurl@latest
```
